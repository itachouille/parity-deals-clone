...
export function Banner({
  ...
  return (
    <>
      ...
      <div className={`${prefix}easy-pdc-container ${prefix}easy-pdc-override`}>
        <span
          className={`${prefix}easy-pdc-message ${prefix}easy-pdc-override`}
        ...
        {!canRemoveBranding && (
          <a
            className={`${prefix}easy-pdc-branding`}
            href={`${env.NEXT_PUBLIC_SERVER_URL}`}
          >
            Powered by Parity Deals Clone
          </a>
        )}
      </div>
    </>
